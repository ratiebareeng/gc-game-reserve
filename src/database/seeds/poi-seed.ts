  ...
  const poisData = [
    {
      name: 'Main Gate',
      type: POIType.GATE,
      description: 'Main entrance to Gaborone Game Reserve. Entry permits and information available here.',
      latitude: -24.6200,
      longitude: 25.9150,
    ...
    },
    {
      name: 'North Gate',
      type: POIType.GATE,
      description: 'Secondary entrance on the northern side of the reserve.',
      latitude: -24.6150,
      longitude: 25.9280,
      facilities: ['Parking'],
      best_time_to_visit: 'Opening hours: 6:00 AM - 6:30 PM',
    ...
    },
    {
      ...
      description: 'Popular spot for observing zebra herds. Best viewing in early morning and late afternoon.',
      latitude: -24.6250,
      longitude: 25.9220,
      facilities: ['Parking Area', 'Viewing Platform'],
      best_time_to_visit: 'Early morning (6:00-8:00 AM) and late afternoon (4:00-6:00 PM)',
    ...
    },
    {
      name: 'Ostrich Plains',
      type: POIType.VIEWPOINT,
      description: 'Open grassland area where ostriches are frequently spotted.',
      latitude: -24.6320,
      longitude: 25.9300,
      facilities: ['Parking'],
      best_time_to_visit: 'All day, especially midday',
      accessibility_notes: 'Accessible from main road',
      is_active: true,
      display_order: 4,
    },
    {
      ...
      description: 'Shaded picnic area with braai facilities. Perfect for family gatherings.',
      latitude: -24.6280,
      longitude: 25.9250,
      facilities: ['Braai Stands', 'Picnic Tables', 'Restrooms', 'Water Taps', 'Shade Shelters'],
    ...
    },
    {
      ...
      type: POIType.PICNIC_AREA,
      description: 'Scenic picnic location near the seasonal river with great wildlife viewing.',
      latitude: -24.6350,
      longitude: 25.9200,
    ...
    },
    {
      ...
      description: 'Primary artificial watering hole. Attracts diverse wildlife, especially during dry season.',
      latitude: -24.6290,
      longitude: 25.9180,
      facilities: ['Viewing Area', 'Parking'],
      best_time_to_visit: 'Early morning and late afternoon for best wildlife activity',
    ...
    },
    {
      ...
      type: POIType.WATERING_HOLE,
      description: 'Smaller watering point frequented by warthogs and smaller mammals.',
      latitude: -24.6180,
      longitude: 25.9260,
      facilities: ['Parking'],
      best_time_to_visit: 'All day',
    ...
    },
    {
      ...
      description: 'Wooden bird hide overlooking acacia woodland. Over 50 bird species recorded here.',
      latitude: -24.6310,
      longitude: 25.9170,
      facilities: ['Bird Hide', 'Benches', 'Information Board'],
      best_time_to_visit: 'Early morning (6:00-9:00 AM) for optimal birdwatching',
    ...
    },
    {
      ...
      type: POIType.BIRD_HIDE,
      description: 'Bird hide overlooking seasonal wetland. Excellent for waterfowl and waders.',
      latitude: -24.6380,
      longitude: 25.9240,
    ...
    },
    {
      ...
      type: POIType.VIEWPOINT,
      description: 'Elevated viewpoint offering panoramic views of the reserve. Popular spot for sunset photography.',
      latitude: -24.6340,
      longitude: 25.9320,
      facilities: ['Parking', 'Viewing Platform'],
      best_time_to_visit: 'Late afternoon (5:00-6:30 PM) for spectacular sunsets',
