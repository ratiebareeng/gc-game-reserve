      ...
      const pois = [
        {
          ...
          type: POIType.GATE,
          description:
            "Primary entrance to Gaborone Game Reserve. Check-in and information point.",
          latitude: -24.6542,
          longitude: 25.9087,
          facilities: [
            "parking",
        ...
        },
        {
          ...
          description:
            "Elevated viewpoint offering panoramic views of the reserve. Popular spot for zebra and ostrich sightings.",
          latitude: -24.66,
          longitude: 25.91,
          facilities: ["parking", "seating", "shade"],
          best_time_to_visit:
            "Early morning (6:00-9:00 AM) and late afternoon (4:00-6:00 PM)",
        ...
        },
        {
          ...
          description:
            "Natural watering hole attracting various wildlife throughout the day. Excellent for photography.",
          latitude: -24.658,
          longitude: 25.912,
        ...
        },
        {
          ...
          description:
            "Dedicated bird watching hide overlooking wetland area. Bring binoculars!",
          latitude: -24.663,
          longitude: 25.908,
          facilities: ["seating", "shade"],
          best_time_to_visit:
            "Early morning (6:00-9:00 AM) for best bird activity",
